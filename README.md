...
- **[`architecture.md`](architecture.md)**: the guideline, from the
  ...
  small project.
- **[`lenses/`](lenses/README.md)**: 232 lenses in eight groups. Each
...
arch-check: ## the guideline's static checks
	uvx --python "$(shell cat .python-version)" --from "git+https://github.com/baristaze/swe_guidelines@v0.23.0\#subdirectory=checkers" arch-check
```
