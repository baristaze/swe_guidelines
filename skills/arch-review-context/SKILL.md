...
description: "Review code or a change through the Context lenses of the Software Design and Architecture Guidelines. Covers OpContext (Stages, Scopes, The Operator Context), Separation of Layers, The Business Layer, The Storage Layer, Infrastructure, The Network Layer, Worker Roles, Telemetry (Correlation Across a Handoff), Cross-Cutting Conventions (Tests): stages, scopes, OperatorContext, authorization, tenancy, provenance. Use for a change that touches this area, or as one leg of arch-review-full."
...
`${CLAUDE_SKILL_DIR}/../../lenses/context.md`. Other perspectives have
