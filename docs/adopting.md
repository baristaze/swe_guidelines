...
```text
/plugin marketplace add https://github.com/baristaze/swe_guidelines.git#v0.30.0
```
...
<https://github.com/baristaze/swe_guidelines/blob/v0.30.0/architecture.md>
(pinned at `v0.30.0`).
