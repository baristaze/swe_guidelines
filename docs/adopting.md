...
```text
/plugin marketplace add https://github.com/baristaze/swe_guidelines.git#v0.8.0
```
...
<https://github.com/baristaze/swe_guidelines/blob/v0.8.0/architecture.md>
(pinned at `v0.8.0`).
