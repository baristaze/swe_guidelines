...
```text
/plugin marketplace add https://github.com/baristaze/swe_guidelines.git#v0.27.0
```
...
```make
ARCH_CHECK := uvx --python "$(shell cat .python-version)" --from "git+https://github.com/baristaze/swe_guidelines@v0.27.0\#subdirectory=checkers" arch-check
...
<https://github.com/baristaze/swe_guidelines/blob/v0.27.0/architecture.md>
(pinned at `v0.27.0`).
